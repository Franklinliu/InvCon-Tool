...
public final class InvConUserBookkeeping2 extends SenaryDerivation {
    ...
    protected InvConUserBookkeeping2(VarInfo vi1, VarInfo vi2, VarInfo vi3, VarInfo vi4, VarInfo vi5,VarInfo vi6) {
    ...
    public ValueAndModified computeValueAndModified(ValueTuple full_vt) {
        ...
        if (val1_array.length == 0){
            // return new ValueAndModified(0.0, ValueTuple.UNMODIFIED);
             if (val4_array instanceof BigInteger[]){
