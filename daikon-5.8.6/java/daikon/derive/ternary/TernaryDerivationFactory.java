...
public abstract class TernaryDerivationFactory implements DerivationFactory {
  ...
  public static boolean checkType(VarInfo vi1, VarInfo vi2) {
    if ((vi1.rep_type == ProglangType.INT_ARRAY) && (vi2.rep_type == ProglangType.INT)) {
      ...
      return true;
    } else if ((vi1.rep_type == ProglangType.BIGINT_ARRAY) && (vi2.rep_type == ProglangType.BIGINT)) {
      return true;
    } else if ((vi1.rep_type == ProglangType.BIGINT) && (vi2.rep_type == ProglangType.BIGINT_ARRAY)) {
      return true;
    } else if ((vi1.rep_type == ProglangType.BIGINT) && (vi2.rep_type == ProglangType.BIGINT)) {
      return true;
    } else {
      return false;
    }
  ...
  public static @Nullable ProglangType returnType(VarInfo vi1, VarInfo vi2) {
    if ((vi1.rep_type == ProglangType.INT_ARRAY) && (vi2.rep_type == ProglangType.INT)) {
      ...
      return ProglangType.BIGINT;
    } else if ((vi1.rep_type == ProglangType.BIGINT) && (vi2.rep_type == ProglangType.BIGINT_ARRAY)) {
      return ProglangType.BIGINT;
    } else if ((vi1.rep_type == ProglangType.BIGINT) && (vi2.rep_type == ProglangType.BIGINT)) {
      return ProglangType.BIGINT_ARRAY;
    } else {
      return null;
    }
  }
