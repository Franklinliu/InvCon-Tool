  ...
  public static boolean applicable(VarInfo vi) {
    ...
    if (vi.derived != null) {
      assert ((vi.derived instanceof SequenceScalarSubsequence)
          ...
          || (vi.derived instanceof SequenceBigIntSubsequence)
          || (vi.derived instanceof SequenceBigIntArbitrarySubsequence)
          || (vi.derived instanceof SequenceBigIntIntersection)
          || (vi.derived instanceof SequenceBigIntUnion)
          || (vi.derived instanceof SequencesPredicateBigInt)
          );
