...
#    cmd = f"""export DAIKONDIR=/home/liuye/daikon-5.8.6
# java -cp $DAIKONDIR/daikon.jar daikon.Daikon --suppress_redundant --user-defined-invariant daikon.inv.binary.sequenceScalar.InfConMsgValueMember   --config_option daikon.VarInfo.declared_type_comparability=false --config_option daikon.PptRelation.enable_object_user=true --config_option daikon.PptTopLevel.pairwise_implications=true  {daikon_full_file} > {invariant_file} """
    cmd = f"""export DAIKONDIR=/home/liuye/Projects/SpecCon/daikon-5.8.6
